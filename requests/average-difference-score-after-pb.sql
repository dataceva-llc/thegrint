...
SELECT
    ...
    CASE
        WHEN (next_round_score - pb_score) > 5 THEN '<5'
        WHEN (next_round_score - pb_score) BETWEEN 5 AND 10 THEN '5_10'
        WHEN (next_round_score - pb_score) BETWEEN 10 AND 15 THEN '10_15'
        WHEN (next_round_score - pb_score) BETWEEN 15 AND 20 THEN '15_20'
        ELSE '20+'
    END AS next_round_score_diff,
    CASE
        WHEN (avg_next5_round_score - pb_score) > 5 THEN '<5'
        WHEN (avg_next5_round_score - pb_score) BETWEEN 5 AND 10 THEN '5_10'
        WHEN (avg_next5_round_score - pb_score) BETWEEN 10 AND 15 THEN '10_15'
        WHEN (avg_next5_round_score - pb_score) BETWEEN 15 AND 20 THEN '15_20'
        ELSE '20+'
    END AS avg_next5_round_score_diff,
    CASE
